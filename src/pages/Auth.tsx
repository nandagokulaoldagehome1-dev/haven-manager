...
export default function Auth() {
  ...
  const checkIfFirstUser = async () => {
    try {
      ...
      if (error) {
        // Table might not exist yet, assume first user
        setIsFirstUser(true);
      } else {
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary items-center justify-center p-12">
        <div className="max-w-md text-center animate-fade-in">
          ...
          <p className="text-primary-foreground/80 text-lg">
            A comprehensive system for managing residents, rooms, payments, and daily operations of your old age home.
          </p>
          <div className="mt-12 grid grid-cols-2 gap-4 text-primary-foreground/70 text-sm">
            <div className="p-4 rounded-xl bg-primary-foreground/10">
              <p className="font-semibold text-primary-foreground">Resident Management</p>
              <p>Track all resident information</p>
            </div>
            <div className="p-4 rounded-xl bg-primary-foreground/10">
              <p className="font-semibold text-primary-foreground">Room Allocation</p>
              <p>Manage occupancy easily</p>
            </div>
            <div className="p-4 rounded-xl bg-primary-foreground/10">
              <p className="font-semibold text-primary-foreground">Payment Tracking</p>
              <p>Generate receipts & bills</p>
            </div>
            <div className="p-4 rounded-xl bg-primary-foreground/10">
              <p className="font-semibold text-primary-foreground">Daily Operations</p>
              <p>Food menu & reminders</p>
            </div>
          </div>
        </div>
      </div>
